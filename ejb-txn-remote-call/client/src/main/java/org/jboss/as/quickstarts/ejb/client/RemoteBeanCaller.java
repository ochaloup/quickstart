...
public class RemoteBeanCaller {
     ...
     * @throws RemoteException when bean call fails
     */
    @TransactionAttribute(value = TransactionAttributeType.NOT_SUPPORTED)
    public List<String> remoteOutboundStatelessNoTxBeanCall() throws NamingException, RemoteException {
     ...
     * @throws RemoteException when bean call fails
     */
    public List<String> remoteOutboundStatelessBeanCall() throws NamingException, RemoteException {
     ...
     * @throws RemoteException when bean call fails
     */
    public List<String> directLookupStatelessBeanOverEjbRemotingCall() throws NamingException, RemoteException {
     ...
     * @throws RemoteException when bean call fails
     */
    public List<String> directLookupStatelessBeanOverHttpCall() throws NamingException, RemoteException {
        log.debugf("Calling direct lookup with transaction to StatelessBean.successOnCall()");
     ...
     */
    @TransactionAttribute(value = TransactionAttributeType.NOT_SUPPORTED)
    public List<String> remoteOutboundStatefulNoTxBeanCall() throws NamingException, RemoteException {
     ...
     * @throws RemoteException when bean call fails
     */
    public String remoteOutboundStatelessBeanFail() throws NamingException, RemoteException {
